;(function($) {
    ...
    $("form.contact_us_form.disabled").each(function(){
        $(this).find(".form-control").attr("disabled","disable");
        $(this).find('button[type="submit"]').attr("disabled","disabled");
        $(this).dins
    })
	$(".edit-form").on("click",function(){
        $(this).closest(".card").find("form.contact_us_form.disabled").removeClass("disabled");
        $(this).closest(".card").find(".form-control").removeAttr("disabled");
        console.log($(this).closest(".card").find(".form-control"))
        $(this).closest(".card").find('button[type="submit"]').removeAttr("disabled");
        $(this).remove();
    })
